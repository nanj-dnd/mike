...
/**
 * Shared text extraction for uploaded documents. Used by tabular reviews
 * and the semantic document index. Returns markdown with "## Page N"
 * headings for paginated sources; empty string when extraction fails.
 */
