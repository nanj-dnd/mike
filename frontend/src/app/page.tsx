...
export default function RootPage() {
  return (
    <main className="min-h-dvh overflow-hidden bg-[#f5f0e8] text-[#1f1d1b]">
      <div className="relative isolate">
        ...
        <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
          ...
          <nav className="flex items-center gap-3 text-sm font-medium">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/45 px-4 py-2.5 text-[#6f1f2e] shadow-[8px_8px_18px_rgba(121,101,73,0.13),-8px_-8px_18px_rgba(255,255,255,0.78)] backdrop-blur-xl transition hover:-translate-y-0.5 hover:bg-white/65"
            >
        ...
        <section className="mx-auto grid max-w-7xl gap-14 px-6 pb-20 pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8 lg:pb-32 lg:pt-28">
          <div>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/45 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.14em] text-[#7d2634] shadow-[5px_5px_14px_rgba(121,101,73,0.1),-5px_-5px_14px_rgba(255,255,255,0.7)] backdrop-blur-xl">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <a
                href="tel:+918104610781"
                className="inline-flex items-center gap-2 rounded-full bg-[#852737] px-5 py-3 text-sm font-semibold text-white shadow-[8px_8px_18px_rgba(102,28,40,0.2),-7px_-7px_15px_rgba(255,255,255,0.55)] transition hover:-translate-y-0.5 hover:bg-[#6f1f2e]"
              >
                Contact us: +91 81046 10781 <ArrowUpRight className="h-4 w-4" />
              </a>
              <a
                href="#what-you-can-do"
                className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/40 px-5 py-3 text-sm font-semibold text-[#5e2a32] shadow-[6px_6px_15px_rgba(121,101,73,0.1),-6px_-6px_15px_rgba(255,255,255,0.7)] backdrop-blur-xl transition hover:bg-white/65"
              >
          ...
          <div className="relative mx-auto w-full max-w-xl lg:max-w-none">
            <div className="absolute -inset-6 -z-10 rounded-[2.5rem] bg-[#d9c6a6]/70 blur-2xl" />
            <div className="rounded-[2rem] border border-white/80 bg-white/40 p-4 shadow-[18px_20px_45px_rgba(116,91,58,0.16),-12px_-12px_30px_rgba(255,255,255,0.7)] backdrop-blur-2xl sm:p-5">
              <div className="rounded-[1.45rem] border border-white/75 bg-[#f8f4ed]/75 p-5 shadow-[inset_1px_1px_0_rgba(255,255,255,0.9),inset_-4px_-4px_12px_rgba(152,126,91,0.08)] sm:p-7">
                <div className="flex items-center justify-between border-b border-[#ded3c4] pb-5">
                  ...
                  <span className="rounded-full border border-white/70 bg-white/50 px-3 py-1 text-xs font-medium text-[#7a2836] shadow-[3px_3px_8px_rgba(121,101,73,0.1),-3px_-3px_8px_rgba(255,255,255,0.75)]">
                    Prepared for law firms
                  </span>
                </div>
                <div className="mt-6 grid grid-cols-2 overflow-hidden rounded-2xl border border-white/80 bg-white/30 shadow-[inset_3px_3px_8px_rgba(133,107,73,0.08),inset_-3px_-3px_8px_rgba(255,255,255,0.7)]">
                  {[
                    ["14", "capability areas"],
                    ...
                    <div key={label} className="border-b border-r border-white/70 p-4 last:border-b-0 sm:p-5">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2">
            {[
              ...
              return (
                <article
                  key={title as string}
                  className="rounded-2xl border border-white/80 bg-white/42 p-6 shadow-[9px_9px_20px_rgba(121,101,73,0.11),-8px_-8px_18px_rgba(255,255,255,0.72),inset_1px_1px_0_rgba(255,255,255,0.75)] backdrop-blur-xl transition hover:-translate-y-1 hover:bg-white/60"
                >
                  <FeatureIcon
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
        <div className="rounded-[2rem] border border-[#a5525d]/35 bg-[#852737] px-7 py-12 text-[#fffaf1] shadow-[16px_16px_35px_rgba(91,29,40,0.22),-9px_-9px_20px_rgba(255,255,255,0.5),inset_1px_1px_0_rgba(255,255,255,0.16)] sm:px-12 sm:py-16 lg:flex lg:items-end lg:justify-between">
          <div className="max-w-2xl">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 rounded-full border border-white/70 bg-white/88 px-5 py-3 text-sm font-semibold text-[#702232] shadow-[6px_6px_14px_rgba(67,20,29,0.22),-5px_-5px_12px_rgba(255,255,255,0.14)] transition hover:-translate-y-0.5 hover:bg-white lg:mt-0"
          >
